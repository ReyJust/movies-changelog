...
export default new Vuex.Store({
  state: {
    ...
    movies: [{
      ...
      "actors": [
        {
          "disambiguation": "III", "id": "/name/nm2225369/", "legacyNameText": "Lawrence, Jennifer (III)",
          "name": "Jennifer Lawrence", "billing": 3, "category": "actress", "characters": ["Katniss Everdeen"], "roles": [{ "character": "Katniss Everdeen", "characterId": "/character/ch0242701/" }]
        }
        ,
        { "id": "/name/nm1242688/", "legacyNameText": "Hutcherson, Josh", "name": "Josh Hutcherson", "billing": 11, "category": "actor", "characters": ["Peeta Mellark"], "roles": [{ "character": "Peeta Mellark", "characterId": "/character/ch0239974/" }] }
        ,
        {
          "id": "/name/nm2955013/", "legacyNameText": "Hemsworth, Liam", "name": "Liam Hemsworth", "billing": 5, "category": "actor", "characters": ["Gale Hawthorne"], "roles": [{ "character": "Gale Hawthorne", "characterId": "/character/ch0244190/" }]
        }
      ]
      ...
      for (let movie in results) {
        ...
        if (results[movie].titleType) {
          ...
          if ((results[movie].titleType === "tvSeries") || (results[movie].titleType === "movie")) {
            ...
            //   console.log(casting[actor].name)
            //   //movies[movie]['casting'].push(casting[actor].name)
            // }
          }
        }
      }
